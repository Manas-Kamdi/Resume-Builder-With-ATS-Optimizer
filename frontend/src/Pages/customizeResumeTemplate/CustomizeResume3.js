...
const CustomizeResume3 = () => {
  ...
  }, [information, education, workExperience, projects, skills, summary, customFields, setResumeData]);
  ...
  const handleNextPage = () => {
    ...
    if (resumeDataId) {
      navigate(`/preview/template?template=3&id=${resumeDataId}&resume=${resumeId}&editable=true`);
    } else {
      navigate(`/preview/template?template=3`);
    }
  };
  return (
    <>
...
export default CustomizeResume3