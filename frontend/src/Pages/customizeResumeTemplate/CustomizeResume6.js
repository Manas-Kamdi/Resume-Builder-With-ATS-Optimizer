...
const CustomizeResume6 = () => {
  ...
  }, [information, education, workExperience, projects, interests, customFields, skills, summary, setResumeData]);
  ...
  const handleNextPage = () => {
    ...
    if (resumeDataId) {
      navigate(`/preview/template?template=6&id=${resumeDataId}&resume=${resumeId}&editable=true`);
    } else {
      navigate(`/preview/template?template=6`);
    }
  };
  return (
    <>
...
export default CustomizeResume6