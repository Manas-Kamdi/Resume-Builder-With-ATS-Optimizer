...
const CustomizeResume2 = () => {
  ...
  const handleNextPage = () => {
    ...
    if (resumeDataId) {
      navigate(`/preview/template?template=2&id=${resumeDataId}&resume=${resumeId}&editable=true`);
    } else {
      navigate(`/preview/template?template=2`);
    }
  };
  return (
    <>
...
export default CustomizeResume2